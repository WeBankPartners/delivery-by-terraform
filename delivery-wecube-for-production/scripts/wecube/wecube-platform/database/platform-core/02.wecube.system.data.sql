...
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('{{PLUGIN_MYSQL_IP}}__mysql__mysqlHost','umadmin','2020-01-21 12:37:03','{{PLUGIN_MYSQL_IP}}',1,'eNgy+i8zfJOUHeCS3te+UA==','root','mysqlHost','3307','ss','active','mysql','umadmin','2020-01-21 12:37:03');
