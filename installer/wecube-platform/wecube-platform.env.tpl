...
GATEWAY_URL='${HOST_PRIVATE_IP}:8005'
JWT_SSO_AUTH_URI='http://${HOST_PRIVATE_IP}:8080/auth/v1/api/login'
JWT_SSO_TOKEN_URI='http://${HOST_PRIVATE_IP}:8080/auth/v1/api/token'
...
WECUBE_CUSTOM_PARAM=
APP_LOG_PATH=${WECUBE_HOME}/logs/platform-core
WECUBE_PORTAL_LOG_PATH=${WECUBE_HOME}/logs/wecube-portal
USER_ACCESS_TOKEN=1440
USER_REFRESH_TOKEN=1800
...
PORTAL_PORT=8080
PUBLIC_DOMAIN='${HOST_PRIVATE_IP}:8080'
...
GATEWAY_PORT=8005
GATEWAY_ROUTE_CONFIG_SERVER='http://${HOST_PRIVATE_IP}:8000'
...
WECUBE_GATEWAY_LOG_PATH=${WECUBE_HOME}/logs/platform-gateway
...
AUTH_SERVER_LOG_PATH=${WECUBE_HOME}/logs/auth-server
