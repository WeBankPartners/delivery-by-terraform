...
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.128.202.3__mysql__mysqlHost','umadmin','2020-01-21 12:37:03','10.128.202.3',1,'eNgy+i8zfJOUHeCS3te+UA==','root','mysqlHost','3307','ss','active','mysql','umadmin','2020-01-21 12:37:03');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.128.202.3__s3__s3Host','umadmin','2020-01-21 14:10:31','10.128.202.3',1,'eB/+3lIm55fJdG3XX9l03w==','access_key','s3Host','9000','ss','active','s3','umadmin','2020-01-21 14:10:31');
