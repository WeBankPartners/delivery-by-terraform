...
./execute_sql_script_file.sh $install_target_host 3307 wecube root $mysql_password "$INSTALLER_DIR/wecube/database/platform-core/05.register_all_plugin_services.sql"
