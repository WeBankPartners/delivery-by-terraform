...
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('global__CORE_ADDR', NULL, 'CORE_ADDR', NULL, 'http://10.128.194.3:19090/platform', 'global', 'system', 'active');
...
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('global__CMDB_URL', NULL, 'CMDB_URL', NULL, 'http://10.128.194.3:20000/wecmdb', 'global', 'system', 'active');
...
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.128.194.3__docker__containerHost','umadmin','2020-01-21 12:36:00','10.128.194.3',1,'4QubBcQ+6jacQdWvOBr7JA==','root','containerHost','22','ss','active','docker','umadmin','2020-01-21 12:36:00');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.128.194.3__mysql__mysqlHost','umadmin','2020-01-21 12:37:03','10.128.194.3',1,'9P+ZliiJRXLctxnDCZOzgQ==','root','mysqlHost','3307','ss','active','mysql','umadmin','2020-01-21 12:37:03');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.128.194.3__s3__s3Host','umadmin','2020-01-21 14:10:31','10.128.194.3',1,'9P+ZliiJRXLctxnDCZOzgQ==','access_key','s3Host','9000','ss','active','s3','umadmin','2020-01-21 14:10:31');
