...
resource "tencentcloud_instance" "instance_squid" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "./utils-sed.sh '{{rdb_wecubecore_ip}}' ${tencentcloud_mysql_instance.TC_HK_PRD1_MGMT_DB_wecubecore.intranet_ip} ${var.wecube_home_folder}/auto-plugin-installer/auto-run.cfg",
      "./utils-sed.sh '{{rdb_wecubeplugin_ip}}' ${tencentcloud_mysql_instance.TC_HK_PRD1_MGMT_DB_wecubeplugin.intranet_ip} ${var.wecube_home_folder}/auto-plugin-installer/auto-run.cfg",
      "./utils-sed.sh '{{lb1_asset_id}}' ${tencentcloud_clb_instance.internal_clb_1.id} ${var.wecube_home_folder}/auto-plugin-installer/auto-run.cfg",
      "./utils-sed.sh '{{lb2_asset_id}}' ${tencentcloud_clb_instance.internal_clb_2.id} ${var.wecube_home_folder}/auto-plugin-installer/auto-run.cfg",
      "./utils-sed.sh '{{lb1_name}}' ${var.lb1_name} ${var.wecube_home_folder}/auto-plugin-installer/auto-run.cfg",
      "./utils-sed.sh '{{lb2_name}}' ${var.lb2_name} ${var.wecube_home_folder}/auto-plugin-installer/auto-run.cfg",
