...
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('system__global__S3_SERVER_URL', NULL, 'S3_SERVER_URL', NULL, 'http://10.40.200.2:9000', 'global', 'system', 'active');
...
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('system__global__CORE_ADDR', NULL, 'CORE_ADDR', NULL, 'http://{{GATEWAY_HOST}}:19090', 'global', 'system', 'active');
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('system__global__GATEWAY_URL', NULL, 'GATEWAY_URL', NULL, 'http://{{GATEWAY_HOST}}:19090', 'global', 'system', 'active');
...
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('system__global__HTTP_PROXY', NULL, 'HTTP_PROXY', NULL, 'http://10.40.220.3:3128', 'global', 'system', 'active');
INSERT INTO `system_variables` (`id`,`package_name`, `name`, `value`, `default_value`, `scope`, `source`, `status`) VALUES ('system__global__HTTPS_PROXY', NULL, 'HTTPS_PROXY', NULL, 'http://10.40.220.3:3128', 'global', 'system', 'active');

INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.40.200.3__docker__containerHost','umadmin','2020-01-21 12:36:00','10.40.200.3',1,'eB/+3lIm55fJdG3XX9l03w==','root','containerHost','22','ss','active','docker','umadmin','2020-01-21 12:36:00');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('{{PLUGIN_MYSQL_IP}}__mysql__mysqlHost','umadmin','2020-01-21 12:37:03','{{PLUGIN_MYSQL_IP}}',1,'eNgy+i8zfJOUHeCS3te+UA==','root','mysqlHost','3306','ss','active','mysql','umadmin','2020-01-21 12:37:03');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.40.200.3__s3__s3Host','umadmin','2020-01-21 14:10:31','10.40.200.3',1,'CqXwzhKmoPOTssB6JUrEOw==','access_key','s3Host','9001','ss','active','s3','umadmin','2020-01-21 14:10:31');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.40.218.3__docker__containerHost','umadmin','2020-01-21 12:36:00','10.40.201.3',1,'eB/+3lIm55fJdG3XX9l03w==','root','containerHost','22','ss','active','docker','umadmin','2020-01-21 12:36:00');
INSERT INTO `resource_server` (`id`,`created_by`, `created_date`, `host`, `is_allocated`, `login_password`, `login_username`, `name`, `port`, `purpose`, `status`, `type`, `updated_by`,`updated_date`) VALUES ('10.40.218.3__s3__s3Host','umadmin','2020-01-21 14:10:31','10.40.201.3',1,'CqXwzhKmoPOTssB6JUrEOw==','access_key','s3Host','9001','ss','active','s3','umadmin','2020-01-21 14:10:31');
